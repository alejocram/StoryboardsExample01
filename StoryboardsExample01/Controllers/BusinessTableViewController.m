...
//
//  Created by Alejocram on 20/07/15.
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    //Se consigue un objecto cell
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"BusinessCell"];
    //Y se llena con los datos
    Business *business = (self.business)[indexPath.row];
    cell.textLabel.text = business.name;
    cell.detailTextLabel.text = business.details;
